...
```bash
docker build --target development --no-cache --tag crai-cffld-feedback-web:development .
```

Run:

```bash
docker run -p 3000:3000 crai-cffld-feedback-web:development
```
...
```bash
docker build --no-cache --tag crai-cffld-feedback-web .
```

Run:

```bash
docker run -p 3000:3000 crai-cffld-feedback-web
```
